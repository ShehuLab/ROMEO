...
namespace Antipatrea
{
    ...
    public:    
        ...
        /**
         *@author Kevin Molloy, Erion Plaku, Amarda Shehu
         *@brief Write PDB file for a configuration
         */
        virtual void WritePDBFile(const Cfg &cfg,
                                          const char fileName[]);

        virtual void WriteScoredPDBFile(const Cfg &cfg,
                                                const char fileName[]);
        /**
         *@author Kevin Molloy, Erion Plaku, Amarda Shehu
        ...
        /**
          ...
          *
          */
        virtual void CreateEnergyFunction(const char *);
