#ifndef Antipatrea_Chain2D_HPP_
#define Antipatrea_Chain2D_HPP_
...
namespace Antipatrea
{
     ...
     *@brief Forward kinematics for a chain in a 2D environment.
     *
     *@remarks
     *  - The start position of the first link is <tt>(0, 0)</tt>.
     */
    class Chain2D : public CfgForwardKinematics
    {
    public:    
        Chain2D(void);
        
        virtual ~Chain2D(void);
