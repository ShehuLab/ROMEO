 ...
 *  - ROMEO looks for the name of the program in the list of the loaded symbols.
 *    - if it finds it, it runs the program passing along the arguments.
 *    - otherwise, it displays a warning message.
 *  - In order for ROMEO to be able to find the program, it should be of the form
...
int main(int argc, char **argv)
{
    ...
    if(argc < 2)
        Logger::m_out << "usage: ROMEO <program_name> [list_of_program_args]" << std::endl;
    else
    {
